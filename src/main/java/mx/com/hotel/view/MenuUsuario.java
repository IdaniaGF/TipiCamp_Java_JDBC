...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/mx/com/hotel/image/logo-40px.png")));
		...
		panelMenu.setBackground(new Color(84,84,84));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/mx/com/hotel/image/logo-150px.png")));
		
		final JPanel btnRegistro = new JPanel();
		btnRegistro.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnRegistro.setBackground(new Color(124, 197, 41));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnRegistro.setBackground(new Color(93, 152, 48));	
			}
			@Override
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/mx/com/hotel/image/reservado.png")));
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBusqueda.setBackground(new Color(124, 197, 41));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnBusqueda.setBackground(new Color(93, 152, 48));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/mx/com/hotel/image/pessoas.png")));
	    ...
	    panelFecha.setBackground(new Color(93, 152, 48));
	    ...
	    labelFecha.setForeground(new Color (30,26,26));
	    ...
	    labelDescripcion.setForeground(new Color(217, 217, 217)); 
	    ...
	    labelDescripcion_1.setForeground(new Color(217, 217, 217)); 
	    ...
	    lblNewLabel_3_1.setForeground(new Color(217, 217, 217)); 
	    ...
	    lblNewLabel_3_2.setForeground(new Color(217, 217, 217)); 
