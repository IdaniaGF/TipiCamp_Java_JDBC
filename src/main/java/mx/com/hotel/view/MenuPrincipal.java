...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("/mx/com/hotel/image/logo-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/mx/com/hotel/image/menu-img.jpg")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/mx/com/hotel/image/logo-150px.png")));
		panel.add(logo);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(0, 500, 910, 37);
		panel_1.setBackground(new Color(93, 152, 48));
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblCopyR = new JLabel("Desarrollado por Idania Guerrero © 2022");
		...
		btnLogin.setBackground(new Color(84,84,84));
		panel.add(btnLogin);
		...
		imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/mx/com/hotel/image/login.png")));
